...
enum AppLocalization {
    ...
    private static let english: [String: String] = [
        ...
        "确认后会自动关闭 ChatGPT": "ChatGPT will close automatically after confirmation",
        "未检测到 ChatGPT，将跳过自动打开": "ChatGPT was not found; automatic opening will be skipped",
        "将账号切换到 %@": "Switch the account to %@",
        "切换完成后会自动重新打开 ChatGPT": "ChatGPT will reopen automatically after switching",
        "切换完成后请重新打开 Codex CLI": "Reopen Codex CLI after switching",
        "切换到 %@": "Switch to %@",
        "取消": "Cancel",
